...
//        byte[] result1 = SignedMessage.encrypt(prikey_lucy, msg);
////        System.out.println(result1.length);
////        byte data = (byte) (result1[2] ^ 255);
////        result1[2] = data;
//
////        result1[2] = result1[2];
//
////        for (int i = 0; i < result1.length; i++) {
////            System.out.print(Integer.toBinaryString(result1[i]) + ",");
////        }
//
////        System.out.println("加密1: " + new String(result1, enc));
////
////        byte[] result2 = SignedMessage.encrypt(pubkey_bob, result1);
////        System.out.println("加密2: " + new String(result2, enc));
////
//        System.out.println("解密: " + SignedMessage.decrypt(pubkey_lucy, result1));
//
//
//
//
